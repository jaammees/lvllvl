...
LotteCRTShader = {
  ...
  uniforms: {
    ...
    "resolution": { type: 'v2', value: new THREE.Vector2(960, 600) },//{ type: 'v2', value: new THREE.Vector2(320, 200) },
    "warpscreen": { type: 'f', value: 1.0 },
    "INPUT_THIN": { type: 'f', value: 0.55 }, //0.55 },
...
//     "uv*=vec2(INPUT_X,INPUT_Y)/iChannelResolution[0].xy;",
     "uv*=vec2(INPUT_X,INPUT_Y)/resolution.xy;",
...
//--------------------------------------------------------------
    ...
    "  fragCoord.xy,",
    "  vec2(INPUT_X,INPUT_Y)/resolution.xy,",
    ...
    "  INPUT_BLUR,",
    "  INPUT_MASK,",
    "  CrtsTone(0.5,0.0,INPUT_THIN,INPUT_MASK));",
