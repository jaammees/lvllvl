      ...
      objects.forEach( function ( object ) {
        ...
        for ( var i = 0, l = faces.length; i < l; i ++ ) {
          ...
          for ( var j = 0; j < 3; j ++ ) {
            ...
            output.setFloat32( offset, vector.x / 4, true ); offset += 4; // vertices
            output.setFloat32( offset, vector.y / 4, true ); offset += 4;
            output.setFloat32( offset, vector.z / 4, true ); offset += 4;

          }

          output.setUint16( offset, 99999, true ); offset += 2; // attribute byte count
