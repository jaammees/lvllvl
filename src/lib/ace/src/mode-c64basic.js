define("ace/mode/c64basic_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
  "use strict";
  
  var oop = require("../lib/oop");
  var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
  
  var C64BasicHighlightRules = function() {
  
      var keywords = (
          "abs|and|asc|atn|chr$|close|"+
          "clr|cmd|cont|cos|data|def|"+
          "dim|end|exp|fn|for|fre|"+
          "get|gosub|goto|if|input|"+//get#|
          "int|left$|len|let|list|"+ //input#|
          "load|log|mid$|new|next|not|"+
          "on|open|or|peek|poke|pos|"+
          "print|read|rem|restore|return|"+ //print#|
  ...
  oop.inherits(C64BasicHighlightRules, TextHighlightRules);
  
  exports.C64BasicHighlightRules = C64BasicHighlightRules;
  });
  ...
  define("ace/mode/c64basic",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/c64basic_highlight_rules","ace/mode/folding/cstyle","ace/range"], function(require, exports, module) {
  "use strict";
  
  var oop = require("../lib/oop");
  var TextMode = require("./text").Mode;
  var C64BasicHighlightRules = require("./c64basic_highlight_rules").C64BasicHighlightRules;
  var CStyleFoldMode = require("./folding/cstyle").FoldMode;
  var Range = require("../range").Range;
  
  var Mode = function() {
      this.HighlightRules = C64BasicHighlightRules;
  ...
  (function() {
      ...
      this.$id = "ace/mode/c64basic";
  }).call(Mode.prototype);
  
  exports.Mode = Mode;
  });                (function() {
                      window.require(["ace/mode/c64basic"], function(m) {
